...
(() => {
  ...
  async function play() {
    ...
    if (!halo || !smile || window.scrollY > innerHeight / 2 || document.hidden) {
      finish();
      return;
    }
    ...
    try {
      ...
      const ringWidth = Math.min(innerWidth * 0.78, 470);
      const faceSize = Math.min(innerWidth * 0.38, 160);
      Object.assign(ring.style, {
        left: "50%",
        top: "50%",
        width: `${ringWidth}px`,
        height: `${ringWidth / 1.55}px`,
      ...
      Object.assign(face.style, {
        ...
        stroke: getComputedStyle(smile).stroke,
      });
      ...
      await Promise.all([
        ...
        animate(
          ...
          [
            ...
            { transform: `translate(${dx * 0.45}px, ${dy * 0.4 - 12}px) scale(.85)`, offset: 0.52 },
            {
